...
def init_alluvial_fan(data_set):
    if data_set["Lithofacies_major"] == "1" and data_set["GR_shape_code"] == "4":
        ...
        if 1 <= u_thick < 10:
            if u_thick >= 7:
                return 5 + additional_point
            elif u_thick >= 4:
                return 4 + additional_point
            else:
                return 3 + additional_point
    return 0
